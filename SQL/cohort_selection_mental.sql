drop materialized view if exists all_data_mental;
create materialized view all_data_mental as
  with lab_aggs as
  (
  ...
  from lab_aggs la
    ...
    on la.hadm_id = di.hadm_id
  where di.icd9_code between '3000' and '3169'
